								...
								},
								{
									...
									_0: A2(
										_elm_lang$html$Html$img,
										{
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$src('http://placehold.it/400x200'),
												_1: {ctor: '[]'}
											}
										},
										{ctor: '[]'}),
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('games-header'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('games-text'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
...
var _user$project$Main$viewPlayer = function (player) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('player-list-item'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					A2(_elm_lang$core$List$map, _user$project$Main$viewPlayer, _p3.players)),
				_1: {ctor: '[]'}
			}
		});
};
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Create Minigames with Elm'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Learn to create fun '),
										_1: {
											ctor: '::',
											_0: A2(
												_elm_lang$html$Html$a,
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('interactive minigames'),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html$text(' with the Elm programming language.'),
												_1: {ctor: '[]'}
											}
										}
									}),
							...
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('content-image platform-image'),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$src('images/platform_sample.png'),
												_1: {ctor: '[]'}
											}
										},
										{ctor: '[]'}),
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('platform-header'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Create a Player Platform with Elixir and Phoenix'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('platform-text'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Create a '),
											_1: {
												ctor: '::',
												_0: A2(
													_elm_lang$html$Html$a,
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('player platform'),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html$text(' to track scores and manage player accounts.'),
													_1: {ctor: '[]'}
												}
											}
										}),
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Want to learn how to create a site like this?'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
...
var _user$project$Main$Player = F2(
	function (a, b) {
		return {username: a, score: b};
	});
var _user$project$Main$decodePlayerData = A3(
	_elm_lang$core$Json_Decode$map2,
...
var _user$project$Main$decodePlayerFetch = A2(
	...
	_user$project$Main$decodePlayerList);
var _user$project$Main$Game = F3(
	function (a, b, c) {
		return {title: a, description: b, authorId: c};
	});
var _user$project$Main$decodeGameData = A4(
	_elm_lang$core$Json_Decode$map3,
...
var _user$project$Main$decodeGameList = _elm_lang$core$Json_Decode$list(_user$project$Main$decodeGameData);
var _user$project$Main$decodeGameFetch = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: 'data',
	...
	_user$project$Main$decodeGameList);
...
var _user$project$Main$hashToPage = function (hash) {
	...
	switch (_p6) {
		...
		case '#/games':
			return _user$project$Main$Games;
		default:
...
var _user$project$Main$FetchGames = function (a) {
	return {ctor: 'FetchGames', _0: a};
};
var _user$project$Main$fetchGames = A2(
...
var _user$project$Main$init = function (location) {
	return {
		...
		_0: _user$project$Main$initialModel(
			_user$project$Main$initPage(location)),
...
var _user$project$Main$locationToMessage = function (location) {
			...
			_elm_lang$html$Html$a,
			{
				...
				_1: {
					...
					_0: _elm_lang$html$Html_Events$onClick(
						_user$project$Main$Navigate(_user$project$Main$Home)),
					_1: {ctor: '[]'}
				}
			},
			{
...
var _user$project$Main$viewNavbarNavLinks = {
	ctor: '::',
	_0: A2(
		_elm_lang$html$Html$li,
		{ctor: '[]'},
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					_elm_lang$html$Html$a,
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$Main$Navigate(_user$project$Main$Games)),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
