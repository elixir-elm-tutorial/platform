...
var _user$project$Platformer$Context = F4(
	function (a, b, c, d) {
...
var _user$project$Platformer$initialSocket = function (context) {
...
var _user$project$Platformer$initialSocketJoin = function (context) {
	return _elm_lang$core$Tuple$first(
		_user$project$Platformer$initialSocket(context));
};
var _user$project$Platformer$initialModel = function (context) {
	return {
		...
		itemPositionY: 300.0,
		itemsCollected: 0,
		phxSocket: _user$project$Platformer$initialSocketJoin(context),
		playersList: {ctor: '[]'},
		playerScore: 0,
		timeRemaining: 10
	};
};
var _user$project$Platformer$initialSocketCommand = function (context) {
...
var _user$project$Platformer$init = function (context) {
	return {
		ctor: '_Tuple2',
		_0: _user$project$Platformer$initialModel(context),
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							...
							_user$project$Platformer$initialSocketCommand(context)),
						_1: {ctor: '[]'}
					}
				}
			})
...
if (typeof _user$project$Platformer$main !== 'undefined') {
    _user$project$Platformer$main(Elm['Platformer'], 'Platformer', undefined);
}
Elm['Pong'] = Elm['Pong'] || {};
