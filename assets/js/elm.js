	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(player.displayName),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
