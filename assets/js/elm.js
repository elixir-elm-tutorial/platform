		...
		var playerTwo = A2(
			...
			_elm_lang$core$List$head(
				A2(
					...
					model.players)));
		var ballCollidedWithPlayerTwo = ((_elm_lang$core$Native_Utils.cmp(ball.positionX, playerTwo.positionX) > -1) && (_elm_lang$core$Native_Utils.cmp(
			ball.positionX,
			playerTwo.positionX + _elm_lang$core$Basics$toFloat(playerTwo.sizeX)) < 1)) && ((_elm_lang$core$Native_Utils.cmp(ball.positionY, playerTwo.positionY) > -1) && (_elm_lang$core$Native_Utils.cmp(
			ball.positionY,
			playerTwo.positionY + _elm_lang$core$Basics$toFloat(playerTwo.sizeY)) < 1));
		var ballCollidedWithPlayerOne = ((_elm_lang$core$Native_Utils.cmp(ball.positionX, playerOne.positionX) > -1) && (_elm_lang$core$Native_Utils.cmp(
			ball.positionX,
			playerOne.positionX + _elm_lang$core$Basics$toFloat(playerOne.sizeX)) < 1)) && ((_elm_lang$core$Native_Utils.cmp(ball.positionY, playerOne.positionY) > -1) && (_elm_lang$core$Native_Utils.cmp(
			ball.positionY,
			playerOne.positionY + _elm_lang$core$Basics$toFloat(playerOne.sizeY)) < 1));
		return ballCollidedWithPlayerOne ? _elm_lang$core$Native_Utils.update(
			ball,
			{
				positionX: (playerOne.positionX + _elm_lang$core$Basics$toFloat(playerOne.sizeX)) + 1,
				velocityX: _elm_lang$core$Basics$abs(ball.velocityX)
			}) : (ballCollidedWithPlayerTwo ? _elm_lang$core$Native_Utils.update(
			ball,
			{positionX: playerTwo.positionX - 1, velocityX: -1.0 * ball.velocityX}) : ((_elm_lang$core$Native_Utils.cmp(ball.positionX, width) > -1) ? _elm_lang$core$Native_Utils.update(
			ball,
