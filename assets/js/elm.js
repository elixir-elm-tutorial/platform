...
var _user$project$Platformer$viewGameplayItem = F2(
	function (model, gameplay) {
		...
		},
		{
			...
			_1: {
				...
				_0: A2(
					...
					A2(
						_elm_lang$core$List$map,
						_user$project$Platformer$viewGameplayItem(model),
						model.gameplays)),
				_1: {ctor: '[]'}
			}
		});
...
var _user$project$Pong$viewNet = A2(
	_elm_lang$svg$Svg$line,
	{
		ctor: '::',
		_0: _elm_lang$svg$Svg_Attributes$x1('445'),
		_1: {
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$y1('0'),
			_1: {
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$x2('445'),
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$y2('600'),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$stroke('white'),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$strokeDasharray('21'),
							_1: {
								ctor: '::',
	...
	{ctor: '[]'});
var _user$project$Pong$viewPlayerScore = F4(
	function (playerId, positionX, positionY, model) {
		var playerScore = A2(
			_elm_lang$core$Maybe$withDefault,
			0,
			_elm_lang$core$List$head(
			...
			},
			{
				...
				_0: A2(
					_elm_lang$svg$Svg$text_,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$fontSize('64'),
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$fontWeight('bold'),
								_1: {
					...
					},
					{
						ctor: '::',
						_0: _elm_lang$svg$Svg$text(
							_elm_lang$core$Basics$toString(playerScore)),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			});
	});
var _user$project$Pong$viewPlayer = function (player) {
	return A2(
		_elm_lang$svg$Svg$rect,
		{
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$fill(player.color),
			_1: {
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$height(
					_elm_lang$core$Basics$toString(player.sizeY)),
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$width(
						_elm_lang$core$Basics$toString(player.sizeX)),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$x(
							_elm_lang$core$Basics$toString(player.positionX)),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$y(
								_elm_lang$core$Basics$toString(player.positionY)),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _user$project$Pong$viewPlayers = function (_p0) {
	var _p1 = _p0;
	return A2(_elm_lang$core$List$map, _user$project$Pong$viewPlayer, _p1.players);
};
var _user$project$Pong$viewBall = function (_p2) {
	var _p3 = _p2;
	var _p4 = _p3.ball;
	return A2(
		_elm_lang$svg$Svg$rect,
		{
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$height(
					_elm_lang$core$Basics$toString(_p4.size)),
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$width(
						_elm_lang$core$Basics$toString(_p4.size)),
					_1: {
						...
						_0: _elm_lang$svg$Svg_Attributes$x(
							_elm_lang$core$Basics$toString(
								_elm_lang$core$Basics$round(_p4.positionX))),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$y(
								_elm_lang$core$Basics$toString(
									_elm_lang$core$Basics$round(_p4.positionY))),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _user$project$Pong$viewGameText = F3(
	function (textPositionX, textPositionY, str) {
		return A2(
			_elm_lang$svg$Svg$text_,
			{
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$color('white'),
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$fontFamily('Courier'),
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$x(
									_elm_lang$core$Basics$toString(textPositionX)),
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$y(
										_elm_lang$core$Basics$toString(textPositionY)),
									_1: {ctor: '[]'}
								}
							}
						}
...
var _user$project$Pong$viewStartScreenText = A2(
	_elm_lang$svg$Svg$svg,
	{ctor: '[]'},
	{
		ctor: '::',
		_0: A3(_user$project$Pong$viewGameText, 280, 160, 'Pong!'),
		_1: {
			ctor: '::',
			_0: A3(_user$project$Pong$viewGameText, 140, 180, 'Press the SPACE BAR key to start.'),
			_1: {ctor: '[]'}
		}
	});
var _user$project$Pong$defaultPlayer = {color: '', id: 0, name: '', positionX: 0, positionY: 0, score: 0, sizeX: 0, sizeY: 0};
var _user$project$Pong$playerOne = function (model) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		_user$project$Pong$defaultPlayer,
		_elm_lang$core$List$head(
			A2(
				_elm_lang$core$List$filter,
				function (p) {
...
var _user$project$Pong$playerTwo = function (model) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		_user$project$Pong$defaultPlayer,
		_elm_lang$core$List$head(
...
var _user$project$Pong$updatePlayerScore = function (player) {
	return _elm_lang$core$Native_Utils.update(
		player,
		{score: player.score + 1});
};
var _user$project$Pong$updatePlayerScores = F2(
	function (ball, players) {
		return (_elm_lang$core$Native_Utils.cmp(ball.positionX, 900.0) > -1) ? A2(
			_elm_lang$core$List$map,
			function (player) {
				return _elm_lang$core$Native_Utils.eq(player.id, 1) ? _user$project$Pong$updatePlayerScore(player) : player;
			},
			players) : ((_elm_lang$core$Native_Utils.cmp(ball.positionX, 0) < 1) ? A2(
			_elm_lang$core$List$map,
			function (player) {
				return _elm_lang$core$Native_Utils.eq(player.id, 2) ? _user$project$Pong$updatePlayerScore(player) : player;
			},
			players) : players);
	});
...
var _user$project$Pong$updateBallPosition = F3(
	function (model, dt, ball) {
		var width = _elm_lang$core$Basics$toFloat(_user$project$Pong$gameWindowWidth);
		var offsetDistance = _elm_lang$core$Basics$toFloat(ball.size);
		var height = _elm_lang$core$Basics$toFloat(_user$project$Pong$gameWindowHeight);
		var defaultPlayer = {color: '', id: 0, positionX: 0, positionY: 0, score: 0, sizeX: 0, sizeY: 0};
		var ballCollidedWithPlayerTwo = ((_elm_lang$core$Native_Utils.cmp(
			ball.positionX,
			_user$project$Pong$playerTwo(model).positionX) > -1) && (_elm_lang$core$Native_Utils.cmp(
			ball.positionX,
			_user$project$Pong$playerTwo(model).positionX + _elm_lang$core$Basics$toFloat(
				_user$project$Pong$playerTwo(model).sizeX)) < 1)) && ((_elm_lang$core$Native_Utils.cmp(
			ball.positionY,
			_user$project$Pong$playerTwo(model).positionY) > -1) && (_elm_lang$core$Native_Utils.cmp(
			ball.positionY,
			_user$project$Pong$playerTwo(model).positionY + _elm_lang$core$Basics$toFloat(
				_user$project$Pong$playerTwo(model).sizeY)) < 1));
		var ballCollidedWithPlayerOne = ((_elm_lang$core$Native_Utils.cmp(
			ball.positionX,
			_user$project$Pong$playerOne(model).positionX) > -1) && (_elm_lang$core$Native_Utils.cmp(
			ball.positionX,
			_user$project$Pong$playerOne(model).positionX + _elm_lang$core$Basics$toFloat(
				_user$project$Pong$playerOne(model).sizeX)) < 1)) && ((_elm_lang$core$Native_Utils.cmp(
			ball.positionY,
			_user$project$Pong$playerOne(model).positionY) > -1) && (_elm_lang$core$Native_Utils.cmp(
			ball.positionY,
			_user$project$Pong$playerOne(model).positionY + _elm_lang$core$Basics$toFloat(
				_user$project$Pong$playerOne(model).sizeY)) < 1));
		return ballCollidedWithPlayerOne ? _elm_lang$core$Native_Utils.update(
			ball,
			{
				positionX: (_user$project$Pong$playerOne(model).positionX + _elm_lang$core$Basics$toFloat(
					_user$project$Pong$playerOne(model).sizeX)) + 1,
				velocityX: _elm_lang$core$Basics$abs(ball.velocityX)
			}) : (ballCollidedWithPlayerTwo ? _elm_lang$core$Native_Utils.update(
			ball,
			{
				positionX: _user$project$Pong$playerTwo(model).positionX - 1,
				velocityX: -1.0 * ball.velocityX
			}) : ((_elm_lang$core$Native_Utils.cmp(ball.positionX, width) > -1) ? _elm_lang$core$Native_Utils.update(
			ball,
			{positionX: width - offsetDistance, velocityX: -1.0 * ball.velocityX}) : ((_elm_lang$core$Native_Utils.cmp(ball.positionX, 0) < 1) ? _elm_lang$core$Native_Utils.update(
			ball,
			{
				positionX: 1.0,
				velocityX: _elm_lang$core$Basics$abs(ball.velocityX)
			}) : ((_elm_lang$core$Native_Utils.cmp(ball.positionY, 600.0) > -1) ? _elm_lang$core$Native_Utils.update(
			ball,
			{positionY: height - offsetDistance, velocityY: -1.0 * ball.velocityY}) : ((_elm_lang$core$Native_Utils.cmp(ball.positionY, 0) < 1) ? _elm_lang$core$Native_Utils.update(
			ball,
			{
				positionY: 1.0,
				velocityY: _elm_lang$core$Basics$abs(ball.velocityY)
			}) : _elm_lang$core$Native_Utils.update(
			ball,
			{positionX: ball.positionX + (ball.velocityX * dt), positionY: ball.positionY + (ball.velocityY * dt)}))))));
	});
var _user$project$Pong$updatePlayerPosition = F2(
	function (keyCode, player) {
		var moveSpeed = 5.0;
		if (_elm_lang$core$Native_Utils.eq(player.id, 1)) {
			var _p5 = keyCode;
			switch (_p5) {
				case 38:
					return _elm_lang$core$Native_Utils.update(
						player,
						{
							positionY: A2(_elm_lang$core$Basics$max, player.positionY - moveSpeed, 0)
						});
				case 40:
					return _elm_lang$core$Native_Utils.update(
						player,
						{
							positionY: A2(
								...
								_elm_lang$core$Basics$toFloat(_user$project$Pong$gameWindowHeight) - _elm_lang$core$Basics$toFloat(player.sizeY))
						});
				default:
					return player;
			}
...
var _user$project$Pong$viewPlayingState = function (model) {
	return A2(
		_elm_lang$svg$Svg$rect,
		{
			ctor: '::',
...
var _user$project$Pong$viewGameState = function (model) {
	var _p6 = model.gameState;
	switch (_p6.ctor) {
		case 'StartScreen':
			return {
				ctor: '::',
				_0: _user$project$Pong$viewStartScreenText,
				_1: {ctor: '[]'}
			};
		case 'Playing':
			return A2(
				...
				{
					ctor: '::',
					_0: _user$project$Pong$viewPlayingState(model),
					_1: {
						ctor: '::',
						_0: _user$project$Pong$viewBall(model),
						_1: {
							ctor: '::',
							_0: A4(_user$project$Pong$viewPlayerScore, 1, 180, 80, model),
							_1: {
								ctor: '::',
								_0: A4(_user$project$Pong$viewPlayerScore, 2, 660, 80, model),
								_1: {
									ctor: '::',
									_0: _user$project$Pong$viewNet,
									_1: {ctor: '[]'}
								}
							}
						}
				...
				_user$project$Pong$viewPlayers(model));
		default:
			return {ctor: '[]'};
	}
};
...
var _user$project$Pong$initialPlayerTwo = {
	...
	id: 2,
	name: '',
	positionX: _elm_lang$core$Basics$toFloat(_user$project$Pong$gameWindowWidth) - _user$project$Pong$distanceFromEdge,
	positionY: (_elm_lang$core$Basics$toFloat(_user$project$Pong$gameWindowHeight) / 2) - _user$project$Pong$distanceFromEdge,
	score: 0,
	sizeX: 10,
	sizeY: 80
};
var _user$project$Pong$initialPlayerOne = {
	color: 'white',
	id: 1,
	name: '',
	positionX: _user$project$Pong$distanceFromEdge,
	positionY: (_elm_lang$core$Basics$toFloat(_user$project$Pong$gameWindowHeight) / 2) - _user$project$Pong$distanceFromEdge,
	score: 0,
	sizeX: 10,
	sizeY: 80
};
var _user$project$Pong$initialPlayers = {
	ctor: '::',
	_0: _user$project$Pong$initialPlayerOne,
	_1: {
		ctor: '::',
		_0: _user$project$Pong$initialPlayerTwo,
		_1: {ctor: '[]'}
	}
};
...
var _user$project$Pong$Player = F8(
	function (a, b, c, d, e, f, g, h) {
		return {color: a, id: b, name: c, positionX: d, positionY: e, score: f, sizeX: g, sizeY: h};
	});
var _user$project$Pong$Model = F8(
	function (a, b, c, d, e, f, g, h) {
		return {ball: a, errors: b, gameplays: c, gamePlayers: d, gameState: e, playerInput: f, phxSocket: g, players: h};
	});
...
var _user$project$Pong$UpdatePaddlePositionSuccess = function (a) {
	return {ctor: 'UpdatePaddlePositionSuccess', _0: a};
};
var _user$project$Pong$UpdatePaddlePositionError = function (a) {
	return {ctor: 'UpdatePaddlePositionError', _0: a};
};
...
var _user$project$Pong$SetPlayerName = {ctor: 'SetPlayerName'};
var _user$project$Pong$ReceivePaddlePositionUpdate = function (a) {
	return {ctor: 'ReceivePaddlePositionUpdate', _0: a};
};
...
var _user$project$Pong$initialSocket = function (context) {
	...
	return A2(
		...
		A4(
			...
			'paddle:position_y',
			'game:pong',
			_user$project$Pong$ReceivePaddlePositionUpdate,
			A4(
				_fbonetti$elm_phoenix_socket$Phoenix_Socket$on,
				'paddle:position_y',
				'game:pong',
		...
		switch (_p7.ctor) {
			...
			case 'MovePlayerOne':
				...
				var payload = _elm_lang$core$Json_Encode$object(
					{
						...
						_0: {
							...
							_1: _elm_lang$core$Json_Encode$float(
								A2(
									_user$project$Pong$updatePlayerPosition,
									_p13,
									_user$project$Pong$playerOne(model)).positionY)
						},
						_1: {ctor: '[]'}
					});
				var phxPush = A2(
					_fbonetti$elm_phoenix_socket$Phoenix_Push$onError,
					_user$project$Pong$UpdatePaddlePositionError,
					A2(
						_fbonetti$elm_phoenix_socket$Phoenix_Push$onOk,
						_user$project$Pong$UpdatePaddlePositionSuccess,
						A2(
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{phxSocket: phxSocket, players: updatedPlayers}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Pong$PhoenixMsg, phxCmd)
				};
			case 'NoOp':
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			...
			case 'ReceivePaddlePositionUpdate':
				...
				if (_p17.ctor === 'Ok') {
					var updatedPlayers = A2(
						_elm_lang$core$List$map,
						function (p) {
							return _elm_lang$core$Native_Utils.eq(p.id, 1) ? _elm_lang$core$Native_Utils.update(
								p,
								{positionY: _p17._0}) : p;
						},
						model.players);
			...
			case 'SetPlayerName':
				var player = _user$project$Pong$playerOne(model);
				var updatedPlayers = A2(
					_elm_lang$core$List$map,
					function (p) {
						return _elm_lang$core$Native_Utils.eq(p.id, 1) ? _elm_lang$core$Native_Utils.update(
							player,
							{name: model.playerInput}) : p;
					},
					model.players);
				return {
					ctor: '_Tuple2',
			...
			case 'UpdateBallPositionSuccess':
				return A2(
					...
					{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
			case 'UpdatePaddlePositionError':
				return A2(
					_elm_lang$core$Debug$log,
					'Error sending paddle position over socket.',
					{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
			default:
				return A2(
					_elm_lang$core$Debug$log,
					'Success sending paddle position over socket.',
					{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
		}
	});
var _user$project$Pong$NoOp = {ctor: 'NoOp'};
var _user$project$Pong$MovePlayerOne = function (a) {
	return {ctor: 'MovePlayerOne', _0: a};
};
var _user$project$Pong$InputPlayerName = function (a) {
	return {ctor: 'InputPlayerName', _0: a};
};
var _user$project$Pong$viewSignIn = function (model) {
	return A2(
					...
					_1: {
						...
						_0: A2(
							_elm_lang$html$Html$input,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onInput(_user$project$Pong$InputPlayerName),
									_1: {
										ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$svg$Svg$text('This will be your display name during the game.'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('b ph3 pv2 input-reset ba b--black bg-transparent grow pointer f6'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_user$project$Pong$SetPlayerName),
									_1: {
										ctor: '::',
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _user$project$Pong$viewSignIn(model),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _user$project$Pong$GameLoop = function (a) {
	return {ctor: 'GameLoop', _0: a};
};
var _user$project$Pong$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _elm_lang$animation_frame$AnimationFrame$diffs(_user$project$Pong$GameLoop),
			_1: {
				ctor: '::',
				_0: _elm_lang$keyboard$Keyboard$downs(_user$project$Pong$MovePlayerOne),
				_1: {
					ctor: '::',
...
if (typeof _user$project$Pong$main !== 'undefined') {
    _user$project$Pong$main(Elm['Pong'], 'Pong', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Json.Encode.Value":{"args":[],"tags":{"Value":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"Phoenix.Socket.Msg":{"args":["msg"],"tags":{"ChannelErrored":["String"],"ChannelClosed":["String"],"ExternalMsg":["msg"],"ChannelJoined":["String"],"Heartbeat":["Time.Time"],"NoOp":[],"ReceiveReply":["String","Int"]}},"Pong.Msg":{"args":[],"tags":{"FetchGameplaysList":["Result.Result Http.Error (List Pong.Gameplay)"],"GameLoop":["Time.Time"],"UpdateBallPositionSuccess":["Json.Encode.Value"],"UpdateBallPositionError":["Json.Encode.Value"],"MovePlayerOne":["Keyboard.KeyCode"],"StartGame":["Keyboard.KeyCode"],"FetchPlayersList":["Result.Result Http.Error (List Pong.GamePlayer)"],"PhoenixMsg":["Phoenix.Socket.Msg Pong.Msg"],"InputPlayerName":["String"],"UpdatePaddlePositionError":["Json.Encode.Value"],"ReceiveBallPositionUpdate":["Json.Encode.Value"],"UpdatePaddlePositionSuccess":["Json.Encode.Value"],"ReceivePaddlePositionUpdate":["Json.Encode.Value"],"SetPlayerName":[],"NoOp":[]}}},"aliases":{"Pong.Gameplay":{"args":[],"type":"{ gameId : Int, playerId : Int, playerScore : Int }"},"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Keyboard.KeyCode":{"args":[],"type":"Int"},"Pong.GamePlayer":{"args":[],"type":"{ displayName : Maybe.Maybe String , id : Int , score : Int , username : String }"},"Time.Time":{"args":[],"type":"Float"}},"message":"Pong.Msg"},"versions":{"elm":"0.18.0"}});
}
